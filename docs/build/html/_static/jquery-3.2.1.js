...
(function(global, factory) {
  ...
  function adjustCSS(elem, prop, valueParts, tween) {
    ...
    var initialInUnit = (jQuery.cssNumber[prop] || (unit !== "px" && +initial)) && rcssNum.exec(jQuery.css(elem, prop));
  ...
  jQuery.each(["height", "width"], function(i, name) {
    jQuery.cssHooks[name] = {
      ...
      set: function(elem, value, extra) {
        ...
        var subtract = extra && augmentWidthOrHeight(elem, name, extra, jQuery.css(elem, "boxSizing", false, styles) === "border-box", styles);
