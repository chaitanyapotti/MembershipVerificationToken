...
require = (function n(e, i, t) {
  ...
  for (var r = typeof require === "function" && require, s = 0; s < t.length; s++) o(t[s]);
  return o;
})(
  {
    "sphinx-rtd-theme": [
      function(n, e, i) {
        var jQuery = typeof window !== "undefined" ? window.jQuery : n("jquery");
        (e.exports.ThemeNav = {
          navBar: null,
          win: null,
          winScroll: !1,
          ...
          reset: function() {
            ...
            try {
              ...
              if (i.length === 0) {
                ...
                (i = e.find('[href="#' + t.attr("id") + '"]')).length === 0 && (i = e.find('[href="#"]'));
              }
              i.length > 0 &&
          ...
          onScroll: function() {
            ...
            var e = n + this.winHeight;
            var i = this.navBar.scrollTop() + (n - this.winPosition);
