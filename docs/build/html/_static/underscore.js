...
(function() {
  ...
  b.uniq = b.unique = function(a, c, d) {
    ...
    b.reduce(
      d,
      function(d, g, h) {
        if (h == 0 || (c === true ? b.last(d) != g : !b.include(d, g))) (d[d.length] = g), (e[e.length] = a[h]);
        return d;
      },
      []
    );
  ...
  b.bind = function(a, c) {
    ...
    return (d = function() {
      ...
      var b = new F();
      var g = a.apply(b, e.concat(i.call(arguments)));
